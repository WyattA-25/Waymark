...
// limitOverride raises or lowers the bucket default per call (Pro plans).
export function rateLimit(req, bucket, key = null, limitOverride = null) {
  const ip = key
  ...
  entry.count += 1;
  if (entry.count > (limitOverride || LIMITS[bucket] || 60)) {
